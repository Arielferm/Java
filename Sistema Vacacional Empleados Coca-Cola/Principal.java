...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal() {
      ...
      labelfooter = new JLabel("©2025 The Coca-Cola Company | Todos los derechos reservados");
	    ...
	    String Antiguedad = comboAntiguedad.getSelectedItem().toString();
            ...
            if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
               Departamento.equals("") || Antiguedad.equals("")){
                ...
                if(Departamento.equals("Atencíon al Cliente")){
				...
				if(Antiguedad.equals("7 a os o más de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien trabaja en " + Departamento + " con " + Antiguedad + 
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
         ...
         JOptionPane.showMessageDialog(null,"Desarrollado por Ariel");
        }
    }
